...
[![License](https://img.shields.io/badge/License-MIT-3ddc84?style=flat-square)](LICENSE)

![LeafAI Banner](https://img.shields.io/badge/38%20Disease%20Classes-14%20Plant%20Species-1A4D35?style=for-the-badge&logo=leaf&logoColor=3ddc84)
...
```
# Trained model (too large for GitHub — share separately)
*.keras
*.h5
models/*.keras
...
Made with 🌿 by **Team GreenByte** · 2026

*LeafAI — Because every crop deserves a diagnosis.*
